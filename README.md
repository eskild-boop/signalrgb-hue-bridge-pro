...
```powershell
git clone https://github.com/<your-username>/signalrgb-hue-bridge-pro.git
...
Diagnosis and patches by [@eabergan](https://github.com/<your-username>) with assistance from Claude (Anthropic) and OpenAI Codex. The endianness clue came from Codex spotting an undocumented optional argument in the SignalRGB plugin runtime docs.
